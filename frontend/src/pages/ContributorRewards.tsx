...
const RewardTier = ({
    ...
    >
        ...
        <div className="text-3xl font-black mb-4 tracking-tight" style={{ color }}>{amount}</div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
            ...
            >
                ...
                <p className="text-xl text-(--muted) max-w-3xl mx-auto leading-relaxed">
                    We believe in rewarding the developers who help build the future of PayD.
                    Solve high-priority issues and get paid directly in XLM or USDC on the Stellar network.
                </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <h2 className="text-4xl font-black mb-8 tracking-tight">How it <span className="text-(--accent)">Works</span></h2>
                    <div className="space-y-8">
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-(--muted)">Look for issues with the <span className="text-(--accent)">reward-eligible</span> label on our GitHub repository.</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-(--muted)">Comment on the issue to express interest. Once assigned, submit your PR with high-quality code and tests.</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-(--muted)">A maintainer will review your work. Once merged, you're eligible for the reward.</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center font-bold text-sm">4</div>
                            <div>
                                <h4 className="font-bold mb-1">Instant Payout</h4>
                                <p className="text-sm text-(--muted)">Provide your Stellar address. The reward will be sent via our automated payroll engine.</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
            ...
            <div className="p-12 glass noise rounded-3xl border border-white/10 text-center">
                ...
                <p className="text-(--muted) max-w-2xl mx-auto mb-8">
                    ...
                    <a href="https://www.freighter.app/" target="_blank" rel="noopener noreferrer" className="text-(--accent) mx-1 hover:underline">Freighter wallet</a>.
                </p>
            </div>
        </div>
    );
