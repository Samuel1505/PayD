...
const API_BASE_URL: string = (import.meta.env.VITE_API_URL as string | undefined) || "http://localhost:3000/api";
...
export const anchorService = {
    ...
    initiatePayment: async (domain: string, secretKey: string, paymentData: PaymentData): Promise<SEP31Transaction> => {
    ...
    getTransactionStatus: async (domain: string, id: string, secretKey: string): Promise<SEP31Transaction> => {
